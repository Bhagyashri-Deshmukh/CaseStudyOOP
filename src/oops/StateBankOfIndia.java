...
public class StateBankOfIndia implements ReserveBankOfIndia {
	...
	public void statutoryRistrictions() {
		...
		System.out.println("Statutory Ristrictions should be followed by SBI");
	}

	@Override
	public void regulatoryRistrictions() {
		// TODO Auto-generated method stub
		System.out.println("Regulatory Ristrictions should be followed by SBI");
	}
